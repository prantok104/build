        ...
        <div class="row">
            <div class="masonary-area">
                ...
                <div class="grid-masonary">
                    <div class="col-md-2  grid-item carpenter plumber">
                    ...
                    <div class="col-md-2  grid-item carpenter repairman">
                        <div class="single-masonary">
                    ...
                    <div class="col-md-2  grid-item plumber">
                        <div class="single-masonary">
                    ...
                    <div class="col-md-2  grid-item builder carpenter">
                        <div class="single-masonary ">
                    ...
                    <div class="col-md-2  grid-item plumber repairman">
                        <div class="single-masonary">
                    ...
                    <div class="col-md-2  grid-item builder plumber repairman">
                        <div class="single-masonary ">
