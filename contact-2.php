...
<!--location1 area start-->
<section class="location1-area c-title-space">
    <div class="container">
        <div class="row">
            <div class="col-md-4">
...
<section class="location1-area">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-5">
                <div class="contact1-img">
                    <div class="contact1-bg">
                        <img src="img/man.png" alt="Contact-img">
                    </div>
                </div>
            </div><!--Contact1 end-->
        </div>
