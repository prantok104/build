    ...
    <div class="container">
        <div class="row">
            <div class="breadcum-area">
                <h1>protfolio-2 layout</h1>
                <span>home / </span><a href="#">portfolio</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="c-title">
                ...
                <h1>portfolio <span>Isotop</span></h1>
...
<section class="masonary-area-start portfolio-area">
   <div class="container">
       <div class="row">
           ...
           <div class="grid-masonary">
               <div class="col-md-6  grid-item carpenter plumber">
               ...
               <div class="col-md-6  grid-item carpenter repairman">
                   <div class="single-masonary">
               ...
               <div class="col-md-6  grid-item plumber">
                   <div class="single-masonary">
               ...
               <div class="col-md-6  grid-item builder carpenter">
                   <div class="single-masonary ">
               ...
               <div class="col-md-6  grid-item repairman">
                   <div class="single-masonary">
               ...
               <div class="col-md-6  grid-item plumber repairman">
                   <div class="single-masonary">
               ...
               <div class="col-md-6  grid-item builder carpenter">
                   <div class="single-masonary ">
                       <img src="img/port6.jpg" alt="port6">
                       <div class="masonary-content">
                           <a href="blog-single.php"><h3>masonary title</h3></a>
                           <p>Lorem ipsum dolor sit amet</p>
                       </div>
               ...
               <div class="col-md-6  grid-item builder plumber repairman">
                   <div class="single-masonary ">
                       <img src="img/port7.jpg" alt="port7">
                       <div class="masonary-content">
                           <a href="blog-single.php"><h3>masonary title</h3></a>
                           <p>Lorem ipsum dolor sit amet</p>
                       </div>
